...
(custom-set-variables
 ...
 '(TeX-parse-self t)
 '(abbrev-mode t t)
 '(agda2-program-args (quote ("-i/home/never/.nix-profile/share/agda")))
 ...
 '(haskell-process-args-ghci
   (quote
    ("-W" "-fdefer-typed-holes" "-ferror-spans" "-ignore-dot-ghci" "-iexamples" "-iprograms" "-isrc" "-itest" "-itests" "-Iinclude" "-outputdir" "ghci-tmp")))
 ...
 '(notmuch-saved-searches
   (quote
    ((:name "inbox" :query "tag:inbox" :key "i")
     ...
     (:name "intelego-zabbix" :query "from:\"Projects Intelego <projects@intelego.net>\" subject:\"FW: *\" tag:unread" :key "ci")
     (:name "recent" :query "date:48h.. not from:diaspora@nerdpol.ch not (from:\"Projects Intelego <projects@intelego.net>\" subject:\"FW: *\")" :key "r")
